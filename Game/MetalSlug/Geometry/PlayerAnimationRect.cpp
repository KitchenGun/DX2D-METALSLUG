#include "stdafx.h"
#include "PlayerAnimationRect.h"
#include "Utilities/Animator.h"

PlayerAnimationRect::PlayerAnimationRect(Vector3 position, Vector3 size, float rotation)
	:position(position),
	size(size),
	rotation(rotation)
{
...
void PlayerAnimationRect::Render()
{
	VB->SetIA();
	IB->SetIA();
	IL->SetIA();
...
void PlayerAnimationRect::Move(Vector3 position)
{
