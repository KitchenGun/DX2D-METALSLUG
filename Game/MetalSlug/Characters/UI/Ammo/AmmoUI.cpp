	...
	:pm(pm)
{
	...
	ammo0 = new TextureRect(Camera::Get()->GetCamPos() + Vector3(450, WinMaxHeight - 50, 0), Vector3(8 * 2, 16 * 1.5f, 1), 0);
	ammo0->SetSRV(L"./_Textures/UI/Ammo0.png");
	ammo1 = new TextureRect(Camera::Get()->GetCamPos() + Vector3(500, WinMaxHeight - 50, 0), Vector3(8 * 2, 16 * 1.5f, 1), 0);
	ammo1->SetSRV(L"./_Textures/UI/Ammo0.png");
	ammo2 = new TextureRect(Camera::Get()->GetCamPos() + Vector3(550, WinMaxHeight - 50, 0), Vector3(8 * 2, 16 * 1.5f, 1), 0);
