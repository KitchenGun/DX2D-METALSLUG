...
Bullet::Bullet(Vector3 position, Vector3 size, float rotation, DIRECTION dir, PROJECTILETYPE BT,SFXManager* sfxm, bool bisPPM)
	:Projectile(position, size, rotation,dir,BT,sfxm, bisPPM)
{
